...
const FAQS = (city: string) => [
    ...
    { q: `Is there a travel fee for events in ${city}?`, a: `Yes, travel is calculated at $2.00 per mile based on the actual driving distance from our Boston dispatch location (ZIP 02108) to ${city}. We'll include the exact fee in your quote.` },
