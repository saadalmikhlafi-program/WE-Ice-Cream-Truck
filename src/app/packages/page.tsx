        ...
        <AnimatePresence mode="wait">
          {activeTab === "truck" ? (
            <motion.div key="truck" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.35 }}>
              ...
              <PackageGrid packages={TRUCK_PACKAGES} accentColor="coral" />
            </motion.div>
          ) : (
            <motion.div key="van" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.35 }}>
              ...
              <PackageGrid packages={VAN_PACKAGES} accentColor="navy" />
            </motion.div>
          )}
        </AnimatePresence>
      </section>
...
// ─── Package Grid ─────────────────────────────────────────────────────────────
function PackageGrid({ packages, accentColor }: { packages: Package[]; accentColor: "coral" | "navy" }) {
